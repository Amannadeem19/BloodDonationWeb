...
const {CreateRequest, getAllRequests, getRequests, deleteRequest, updateRequest, getRequestById} = require('../controllers/Request');


router.post('/create',validateToken2, CreateRequest);
router.get('/myrequests', validateToken2, getRequests);
router.get('/myrequests/:id', validateToken2, getRequestById);
